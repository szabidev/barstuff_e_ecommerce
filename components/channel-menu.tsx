        ...
        <>
            <Menu as="div" className="relative">
                <Menu.Button className="grow flex items-center truncate">
                    <Image className="w-8 h-8 rounded-full mr-2" src={options[selected].image} width={32} height={32}
                           alt="Group 01"/>
                    <div className="truncate">
                        <span
                            className="font-semibold text-slate-800 dark:text-slate-100">#{options[selected].channel}</span>
                    </div>
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="grow flex items-center truncate">
                                                <Image className="w-7 h-7 rounded-full mr-2" src={option.image}
                                                       width={28} height={28} alt="Channel 01"/>
